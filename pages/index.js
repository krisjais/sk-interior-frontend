            ...
            <div className="reveal-left">
              ...
              <div className="space-y-5 mt-10">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div><p className="text-white/80 text-sm">091674 01020</p><p className="text-white/80 text-sm">98707 60240</p><p className="text-white/40 text-xs mt-0.5">Mon–Sat, 10am – 7pm</p></div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[#C8A96A]/10 flex items-center justify-center flex-shrink-0">
